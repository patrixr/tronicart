...
`@tronicart/p5-fest` is a TypeScript package that exports a series of useful functions meant to be used within a P5 script.
...
The `@tronicart/p5-fest` package provides a `colors` module that exports several functions and types related to colors.

To import the `colors` module, use the following syntax:

```typescript
import * as colors from '@tronicart/p5-fest/colors';
```
...
```typescript
import { editPixels } from '@tronicart/p5-fest/pixels';
```
