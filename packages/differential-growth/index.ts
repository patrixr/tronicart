...
export interface Node extends P5.Vector {}
...
class DifferentialGrowth<T extends Path = Path> {
  public paths: T[] = [];
...
export function createDifferentialGrowth<T extends Path = Path>(p5: P5, opts: DGOptions = {}) {
  return new DifferentialGrowth<T>(p5, opts);
}
