...
return (new CustomEvent(event_name,(function (){var obj27184 = ({"detail":data});
return obj27184;
})()));
} else {
...
var f = (function (){var pred__27191 = cljs.core._EQ_;
var expr__27192 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27191.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27192))){
return ((function (pred__27191,expr__27192){
return (function (p1__27185_SHARP_){
return console.warn(p1__27185_SHARP_);
});
;})(pred__27191,expr__27192))
} else {
if(cljs.core.truth_(pred__27191.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27192))){
return ((function (pred__27191,expr__27192){
return (function (p1__27186_SHARP_){
return console.debug(p1__27186_SHARP_);
});
;})(pred__27191,expr__27192))
} else {
if(cljs.core.truth_(pred__27191.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27192))){
return ((function (pred__27191,expr__27192){
return (function (p1__27187_SHARP_){
return console.error(p1__27187_SHARP_);
});
;})(pred__27191,expr__27192))
} else {
return ((function (pred__27191,expr__27192){
return (function (p1__27188_SHARP_){
return console.log(p1__27188_SHARP_);
});
;})(pred__27191,expr__27192))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27195){
...
var opts = map__27196__$1;
var eval_fn = cljs.core.get.call(null,map__27196__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27198_SHARP_);
});})(new_def))
);
...
return (function (p__27199){
var vec__27200 = p__27199;
var ky = cljs.core.nth.call(null,vec__27200,(0),null);
var v = cljs.core.nth.call(null,vec__27200,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1704783952763
