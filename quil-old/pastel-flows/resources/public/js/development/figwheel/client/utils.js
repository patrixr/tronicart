...
return (new CustomEvent(event_name,(function (){var obj25954 = ({"detail":data});
return obj25954;
})()));
} else {
...
var f = (function (){var pred__25961 = cljs.core._EQ_;
var expr__25962 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25961.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25962))){
return ((function (pred__25961,expr__25962){
return (function (p1__25955_SHARP_){
return console.warn(p1__25955_SHARP_);
});
;})(pred__25961,expr__25962))
} else {
if(cljs.core.truth_(pred__25961.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25962))){
return ((function (pred__25961,expr__25962){
return (function (p1__25956_SHARP_){
return console.debug(p1__25956_SHARP_);
});
;})(pred__25961,expr__25962))
} else {
if(cljs.core.truth_(pred__25961.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25962))){
return ((function (pred__25961,expr__25962){
return (function (p1__25957_SHARP_){
return console.error(p1__25957_SHARP_);
});
;})(pred__25961,expr__25962))
} else {
return ((function (pred__25961,expr__25962){
return (function (p1__25958_SHARP_){
return console.log(p1__25958_SHARP_);
});
;})(pred__25961,expr__25962))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25965){
...
var eval_fn = cljs.core.get.call(null,map__25966__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25968_SHARP_);
});})(new_def))
);
...
return (function (p__25969){
var vec__25970 = p__25969;
var ky = cljs.core.nth.call(null,vec__25970,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1703739155664
