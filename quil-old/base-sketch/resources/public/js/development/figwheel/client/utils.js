...
return (new CustomEvent(event_name,(function (){var obj27031 = ({"detail":data});
return obj27031;
})()));
} else {
...
var f = (function (){var pred__27038 = cljs.core._EQ_;
var expr__27039 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27038.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27039))){
return ((function (pred__27038,expr__27039){
return (function (p1__27032_SHARP_){
return console.warn(p1__27032_SHARP_);
});
;})(pred__27038,expr__27039))
} else {
if(cljs.core.truth_(pred__27038.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27039))){
return ((function (pred__27038,expr__27039){
return (function (p1__27033_SHARP_){
return console.debug(p1__27033_SHARP_);
});
;})(pred__27038,expr__27039))
} else {
if(cljs.core.truth_(pred__27038.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27039))){
return ((function (pred__27038,expr__27039){
return (function (p1__27034_SHARP_){
return console.error(p1__27034_SHARP_);
});
;})(pred__27038,expr__27039))
} else {
return ((function (pred__27038,expr__27039){
return (function (p1__27035_SHARP_){
return console.log(p1__27035_SHARP_);
});
;})(pred__27038,expr__27039))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27042){
...
var eval_fn = cljs.core.get.call(null,map__27043__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27045_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27047,(0),null);
var v = cljs.core.nth.call(null,vec__27047,(1),null);
...
}catch (e27052){if((e27052 instanceof Error)){
var e = e27052;
return not_found;
} else {
throw e27052;
...
//# sourceMappingURL=utils.js.map?rel=1704617303090
