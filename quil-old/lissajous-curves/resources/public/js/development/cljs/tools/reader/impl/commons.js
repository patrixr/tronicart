...
var G__21818 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21818;
continue;
} else {
return ch;
...
var vec__21819 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__21819,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21822){
...
return (function() { 
var G__21827__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__21827 = function (rdr,var_args){
var _ = null;
...
while (G__21828__i < G__21828__a.length) {G__21828__a[G__21828__i] = arguments[G__21828__i + 1]; ++G__21828__i;}
  _ = new cljs.core.IndexedSeq(G__21828__a,0,null);
} 
return G__21827__delegate.call(this,rdr,_);};
G__21827.cljs$lang$maxFixedArity = 1;
G__21827.cljs$lang$applyTo = (function (arglist__21829){
var rdr = cljs.core.first(arglist__21829);
var _ = cljs.core.rest(arglist__21829);
return G__21827__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1703259696146
