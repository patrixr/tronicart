...
var f = (function (){var pred__26770 = cljs.core._EQ_;
var expr__26771 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26770.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26771))){
return ((function (pred__26770,expr__26771){
return (function (p1__26764_SHARP_){
return console.warn(p1__26764_SHARP_);
});
;})(pred__26770,expr__26771))
} else {
if(cljs.core.truth_(pred__26770.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26771))){
return ((function (pred__26770,expr__26771){
...
if(cljs.core.truth_(pred__26770.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26771))){
return ((function (pred__26770,expr__26771){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26774){
...
var eval_fn = cljs.core.get.call(null,map__26775__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26777_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26779,(0),null);
var v = cljs.core.nth.call(null,vec__26779,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1703259698646
