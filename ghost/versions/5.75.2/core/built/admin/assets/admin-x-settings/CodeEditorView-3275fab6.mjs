import { a as ke, b as N, bV as Rt, bW as qn, e as wt, bX as Vn, j as F, bY as _n, u as Hn, R as zn, q as Un, d as $n, H as Gn, c as Kn } from "./index-02a155fd.mjs";
import { E as p, F as fe, v as Ee, S as Re, o as d, w as qe, C as Jn, x as jn, y as Tt, z as Ot, A as Se, B as It, G as Pt, H as Wt, J as Ue, K as Ze, M as w, O as X, g as et, b as $e, Q as Qn, R as ee, V as Ft, U as x, W as Yn, X as Xn, Y as ce, Z as M, _ as Zn, $ as er, a0 as tt, a1 as ue, a2 as tr, a3 as nr, a4 as rr, a5 as or, a6 as ir, a7 as sr, a8 as lr, a9 as ar, aa as cr, ab as ur, ac as hr, ad as fr, ae as dr, af as mr, ag as Nt, ah as gr, ai as pr, aj as yr, ak as xr, al as kr, am as br, an as qt, ao as Sr, ap as Cr, t as f, aq as vr } from "./index-9cc1df42.mjs";
const Ar = (t) => {
...
const Ge = /* @__PURE__ */ Ze.define(), wr = /* @__PURE__ */ Ze.define(), Tr = /* @__PURE__ */ fe.define(), _t = /* @__PURE__ */ fe.define({
  combine(t) {
    return Ee(t, {
      minDepth: 100,
      newGroupDelay: 500,
...
function en(t, e) {
  let r = Zt(t), { state: n } = t, o = re(n.selection, (s) => s.empty ? t.moveVertically(s, e, r.height) : Te(s, e));
  if (o.eq(n.selection))
    return !1;
  let i;
  if (r.selfScroll) {
...
const jr = (t) => T(t, (e) => V(t, e, !0)), Qr = (t) => T(t, (e) => V(t, e, !1)), Yr = (t) => T(t, (e) => V(t, e, !b(t))), Xr = (t) => T(t, (e) => V(t, e, b(t))), Zr = (t) => T(t, (e) => d.cursor(t.lineBlockAt(e.head).from, 1)), eo = (t) => T(t, (e) => d.cursor(t.lineBlockAt(e.head).to, -1));
function to(t, e, r) {
...
function cn(t, e) {
  return B(t, (r) => t.moveVertically(r, e, Zt(t).height));
}
...
class Z {
  ...
  static get(e, r, n) {
    ...
    if (!o || o.from >= n || o.to <= r) {
      let l = new Z(r, e.sliceString(r, n));
      return _e.set(e, l), l;
    }
    if (o.from == r && o.to == n)
      return o;
    let { text: i, from: s } = o;
    return s > r && (i = e.sliceString(r, s) + i, s = r), o.to < n && (i += e.sliceString(o.to, n)), _e.set(e, new Z(s, i)), new Z(r, i.slice(r - s, n - s));
  }
}
class vn {
  constructor(e, r, n, o, i) {
    this.text = e, this.to = i, this.done = !1, this.value = Sn, this.matchPos = ve(e, o), this.re = new RegExp(r, it + (n != null && n.ignoreCase ? "i" : "")), this.test = n == null ? void 0 : n.test, this.flat = Z.get(e, o, this.chunkEnd(
      o + 5e3
      /* Base */
    ));
  }
  ...
  next() {
    for (; ; ) {
      ...
      if (this.flat.to == this.to)
        return this.done = !0, this;
      this.flat = Z.get(this.text, this.flat.from, this.chunkEnd(this.flat.from + this.flat.text.length * 2));
    }
  }
}
...
const Xo = /* @__PURE__ */ x.mark({ class: "cm-searchMatch" }), Zo = /* @__PURE__ */ x.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), ei = /* @__PURE__ */ Ft.fromClass(class {
  constructor(t) {
...
const wn = /* @__PURE__ */ w.define(), ct = /* @__PURE__ */ w.define(), Tn = /* @__PURE__ */ w.define(), A = /* @__PURE__ */ Re.define({
  ...
  update(t, e) {
    ...
    for (let r of e.effects)
      r.is(wn) ? t = U.init(r.value, t.panel, e.state) : r.is(ct) ? t = new U(t.diagnostics, r.value ? We.open : null, t.selected) : r.is(Tn) && (t = new U(t.diagnostics, t.panel, r.value));
    return t;
  },
  provide: (t) => [
    tt.from(t, (e) => e.panel),
...
const Si = "#e5c07b", At = "#e06c75", Ci = "#56b6c2", vi = "#ffffff", be = "#abb2bf", Xe = "#7d8799", Ai = "#61afef", Mi = "#98c379", Mt = "#d19a66", Li = "#c678dd", Bi = "#21252b", Lt = "#2c313a", Bt = "#282c34", ze = "#353a42", Di = "#3E4451", Dt = "#528bff", Ei = /* @__PURE__ */ p.theme({
  "&": {
    color: be,
    backgroundColor: Bt
  },
  ...
  return s && typeof s == "function" && se.push(p.updateListener.of(s)), se = se.concat(l), N(() => {
    if (W && !J) {
      var R = {
        ...
        selection: r,
        extensions: se
      }, le = z ? ue.fromJSON(z.json, R, z.fields) : ue.create(R);
      if (j(le), !y) {
        var me = new p({
          state: le,
          parent: W,
...
const Ni = [
  ...
  const S = Hn(), D = wt(null), [$, G] = ke(100), [_, K] = zn.useState(null), { setFocusState: H } = Un(), ie = (E) => {
    c == null || c(E), H(!0);
  }, z = (E) => {
    u == null || u(E), H(!1);
  };
...
//# sourceMappingURL=CodeEditorView-3275fab6.mjs.map
